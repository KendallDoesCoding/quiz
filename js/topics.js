      ...
      document.getElementById(containerId).classList.toggle("show");
                     ...
                     document.getElementById("technology")
                         .addEventListener("click",
                                           () => toggleHidde("technologyMore"));

document.getElementById("games").addEventListener(
    "click", () => toggleHidde("gamesMore"));

document.getElementById("festivals")
    .addEventListener("click", () => toggleHidde("festivalsMore"));

document.getElementById("general").addEventListener(
    "click", () => toggleHidde("generalMore"));

document.getElementById("youtube").addEventListener(
    "click", () => toggleHidde("youtubeMore"));

document.getElementById("others").addEventListener(
    "click", () => toggleHidde("othersMore"));
